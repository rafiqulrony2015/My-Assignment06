...
const createSlider = () => {
  ...
  if (duration <= 300) {
    duration = 1000;
    if (confirm("1s default for slider duration")) {
...
const enterSearchBtn = inputField.addEventListener('keypress', function (event) {
